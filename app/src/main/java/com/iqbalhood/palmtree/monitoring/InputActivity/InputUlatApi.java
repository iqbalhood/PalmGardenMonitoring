...
public class InputUlatApi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_turnera_subulata);
    ...
    public void setData(){
        ...
        BarDataSet dataset = new BarDataSet(entries, "# Jumlah Ulat Api per Pelepah ");
