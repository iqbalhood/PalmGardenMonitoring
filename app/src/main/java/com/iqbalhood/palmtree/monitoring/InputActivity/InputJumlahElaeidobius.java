...
public class InputJumlahElaeidobius extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jumlah_elaeidobius);
...
//            Toast.makeText(getApplicationContext(), "Data Bulan Belum ada  Data " + count, Toast.LENGTH_SHORT).show();
    ...
    public void setData() {
        ...
        BarDataSet dataset = new BarDataSet(entries, "# Grafik Elaeidobius ");
